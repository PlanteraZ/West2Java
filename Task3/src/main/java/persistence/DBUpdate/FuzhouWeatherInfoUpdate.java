...
public class FuzhouWeatherInfoUpdate {
    ...
    private void updateFuzhou1stDayWeatherInfo(JSONObject fuzhouWeatherJSON) {
        fuzhouWeatherInfoSet.setFuzhou1stDayWeatherInfo(fuzhou1stDayWeather, fuzhouWeatherJSON);

        Connection conn = null;
        PreparedStatement pstmt = null;

        String updateFuzhou1stDayWeatherInfo = "INSERT INTO fuzhouweatherinfo (updateTime, city_name, fxDate, tempMax, tempMin, textDay) " +
        ...
        try {
            ...
            pstmt = conn.prepareStatement(updateFuzhou1stDayWeatherInfo);
            ...
            pstmt.setObject(7, fuzhou1stDayWeather.getUpdateTime());
            pstmt.setInt(8, fuzhou1stDayWeather.getTempMax());
            pstmt.setInt(9, fuzhou1stDayWeather.getTempMin());
            pstmt.setString(10, fuzhou1stDayWeather.getTextDay());
            pstmt.executeUpdate();
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
    ...
    private void updateFuzhou2ndDayWeatherInfo(JSONObject fuzhouWeatherJSON) {
        fuzhouWeatherInfoSet.setFuzhou2ndDayWeatherInfo(fuzhou2ndDayWeather, fuzhouWeatherJSON);

        Connection conn = null;
        PreparedStatement pstmt = null;

        String updateFuzhou2ndDayWeatherInfo = "INSERT INTO fuzhouweatherinfo (updateTime, city_name, fxDate, tempMax, tempMin, textDay) " +
                "VALUES (?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE updateTime = ?, tempMax = ?, tempMin = ?, textDay = ?;";
        ...
        try {
            ...
            pstmt = conn.prepareStatement(updateFuzhou2ndDayWeatherInfo);
            ...
            pstmt.setObject(7, fuzhou2ndDayWeather.getUpdateTime());
            pstmt.setInt(8, fuzhou2ndDayWeather.getTempMax());
            pstmt.setInt(9, fuzhou2ndDayWeather.getTempMin());
            pstmt.setString(10, fuzhou2ndDayWeather.getTextDay());
            pstmt.executeUpdate();
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
    ...
    private void updateFuzhou3rdDayWeatherInfo(JSONObject fuzhouWeatherJSON) {
        fuzhouWeatherInfoSet.setFuzhou3rdDayWeatherInfo(fuzhou3rdDayWeather, fuzhouWeatherJSON);

        Connection conn = null;
        PreparedStatement pstmt = null;

        String updateFuzhou3rdDayWeatherInfo = "INSERT INTO fuzhouweatherinfo (updateTime, city_name, fxDate, tempMax, tempMin, textDay) " +
                "VALUES (?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE updateTime = ?, tempMax = ?, tempMin = ?, textDay = ?;";
        ...
        try {
            ...
            pstmt = conn.prepareStatement(updateFuzhou3rdDayWeatherInfo);
            ...
            pstmt.setObject(7, fuzhou3rdDayWeather.getUpdateTime());
            pstmt.setInt(8, fuzhou3rdDayWeather.getTempMax());
            pstmt.setInt(9, fuzhou3rdDayWeather.getTempMin());
            pstmt.setString(10, fuzhou3rdDayWeather.getTextDay());
            pstmt.executeUpdate();
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
    ...
    public void updateFuzhouWeatherInfo() throws IOException {
        JSONObject fuzhouWeatherJSON = getFuzhouWeatherJSON(key, fuzhouId);
        updateFuzhou1stDayWeatherInfo(fuzhouWeatherJSON);
        updateFuzhou2ndDayWeatherInfo(fuzhouWeatherJSON);
        updateFuzhou3rdDayWeatherInfo(fuzhouWeatherJSON);
    }
}
