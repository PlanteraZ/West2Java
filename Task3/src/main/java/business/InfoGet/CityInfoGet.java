...
public class CityInfoGet {
    public String getCityInfo(String key, String cityName) throws IOException {
        String cityQueryURL = "https://geoapi.qweather.com/v2/city/lookup?key=" + key + "&location=" + cityName;
        //1.创建httpclient对象
